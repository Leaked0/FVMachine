...
namespace FVM
{
	public static class Utils
	{
		...
		{
			MethodDefUser method = new MethodDefUser(Utils.GetRealString(), MethodSig.CreateStatic(mod.CorLibTypes.Void), MethodImplAttributes.IL, MethodAttributes.FamANDAssem | MethodAttributes.Family | MethodAttributes.Static);
			method.Body = new CilBody();
			mod.GlobalType.Methods.Add(method);
			return method;
		}

		// Token: 0x0600001A RID: 26 RVA: 0x00002E98 File Offset: 0x00001098
		public static FieldDefUser CreateField(FieldSig sig)
		{
			return new FieldDefUser(Utils.GetRealString(), sig, FieldAttributes.FamANDAssem | FieldAttributes.Family | FieldAttributes.Static);
		}

		// Token: 0x0600001B RID: 27 RVA: 0x00002EBC File Offset: 0x000010BC
		public static int RandomSmallInt32()
		{
			return Utils.rnd.Next(15, 40);
		}

		// Token: 0x0600001C RID: 28 RVA: 0x00002ECC File Offset: 0x000010CC
		public static int RandomInt32()
		{
			return Utils.rnd.Next(100, 500);
		}

		// Token: 0x0600001D RID: 29 RVA: 0x00002EDF File Offset: 0x000010DF
		public static int RandomBigInt32()
		{
			return Utils.rnd.Next();
		}

		// Token: 0x0600001E RID: 30 RVA: 0x00002EEB File Offset: 0x000010EB
		public static bool RandomBoolean()
		{
			return Convert.ToBoolean(Utils.rnd.Next(0, 2));
		}

		// Token: 0x0600001F RID: 31 RVA: 0x00002F00 File Offset: 0x00001100
		public static Code GetCode(bool supported = false)
		{
			Code[] array = new Code[5];
			RuntimeHelpers.InitializeArray(array, fieldof(<PrivateImplementationDetails>.C492F2DDD94111192AAE8E138FFC99759143B4D108650334C78C4018BEAF9196).FieldHandle);
			Code[] codes = array;
			if (supported)
			{
				Code[] array2 = new Code[3];
				RuntimeHelpers.InitializeArray(array2, fieldof(<PrivateImplementationDetails>.FF6079903FB1848A479C8F21E22ACAB408D477942E57F3DFE8A67709472BE86B).FieldHandle);
				codes = array2;
			}
			return codes[Utils.rnd.Next(0, codes.Length)];
		}

		// Token: 0x06000020 RID: 32 RVA: 0x00002F4C File Offset: 0x0000114C
		public static string GetRealString()
		{
			string[] charsc = new string[]
			{
				"CausalityTraceLevel",
				"BitConverter",
			...
			return charsc[Utils.rnd.Next(charsc.Length)];
		}
